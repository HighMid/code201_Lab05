...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    let productMessage = (`The product of ${a} and ${b} and ${5} is ${totalProduct}.`);
...
function sumArray(sumArr) { //eslint-disable-line
    ...
    let sumMessage = (`${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${totalSum} is their sum.`);

    return [totalSum, sumMessage];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    let productMessage = (`The numbers ${dynamicArray[0]},${dynamicArray[1]},${dynamicArray[2]},${dynamicArray[3]},${dynamicArray[4]} have a product of ${finalProduct}.`);
